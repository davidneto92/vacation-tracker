...
#     let!(:park_02) { FactoryGirl.create(:park, name: "Carlsbad Caverns", latitude: 32.148, longitude: -104.557) }
#     let!(:park_03) { FactoryGirl.create(:park, name: "Guadalupe Mountains", latitude: 31.945, longitude: -104.873) }
#     let!(:park_04) { FactoryGirl.create(:park, name: "Arches", latitude: 38.733, longitude: -109.593) }
